...
**Reference:** See `docs/v5-structure-division.md` Part 8 for file list.
...
1. Read `docs/v5-structure-division.md` Part 8 for the complete file list
...
**Alignment:** (E) Phase 3 → (B) Part 8 → (C) This file (placeholder)
