    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          <div className="text-2xl font-bold mb-2">Loading billing information...</div>
        ...
        <Card className="bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-2xl shadow-2xl mb-8 border-0">
          <CardContent className="p-8">
            <div className="flex flex-wrap gap-2 mb-4">
              <Badge className="bg-white/20 text-white hover:bg-white/30">PRO TIER ⭐</Badge>
                      ...
                      >
                        ...
                        <td className="p-3 text-center">
                          <Button
                            variant="link"
                            size="sm"
                            onClick={() => console.log("Download PDF for", item.date)}
                          >
                            Download PDF
                          </Button>
                        </td>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="text-center p-4">
                  ...
                  <Button
                    ...
                    onClick={() => console.log("Configure notifications clicked")}
                  >
                    Configure
                  </Button>
                </div>
