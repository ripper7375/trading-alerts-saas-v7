    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 p-4 sm:p-8">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">Tier-aware chart controls with symbol and timeframe selectors</p>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-md p-8">
          <div className="aspect-video bg-gradient-to-br from-blue-50 to-purple-50 rounded-lg flex items-center justify-center">
            <div className="text-center">
              ...
              <p className="text-gray-600">Chart data would be displayed here</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
          <div className="bg-white rounded-lg shadow p-4">
            <h3 className="font-semibold text-gray-900 mb-2">Symbols Available</h3>
            <p className="text-2xl font-bold text-blue-600">{userTier === "FREE" ? "5" : "15"}</p>
            <p className="text-xs text-gray-600 mt-1">
              {userTier === "FREE" ? "Upgrade for 10 more" : "All symbols unlocked"}
            </p>
          </div>

          <div className="bg-white rounded-lg shadow p-4">
            <h3 className="font-semibold text-gray-900 mb-2">Timeframes</h3>
            <p className="text-2xl font-bold text-purple-600">{userTier === "FREE" ? "3" : "9"}</p>
            <p className="text-xs text-gray-600 mt-1">
              {userTier === "FREE" ? "Upgrade for 6 more" : "All timeframes unlocked"}
            </p>
          </div>

          <div className="bg-white rounded-lg shadow p-4">
            <h3 className="font-semibold text-gray-900 mb-2">Update Frequency</h3>
            <p className="text-2xl font-bold text-green-600">{userTier === "FREE" ? "60s" : "30s"}</p>
            <p className="text-xs text-gray-600 mt-1">
              {userTier === "FREE" ? "Upgrade for faster updates" : "Priority updates"}
            </p>
          </div>
        </div>
      </div>
