  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      {affiliateCode && (
        <div className="bg-green-500 text-white py-3 px-4 text-center">
          <p className="text-sm">
            ...
            <code className="bg-white/20 px-2 py-1 rounded font-mono">{affiliateCode}</code>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex items-center gap-8">
              ...
              <button onClick={() => scrollToSection('affiliate')} className="text-blue-600 font-medium hover:underline transition">
                Affiliates
              </button>
          ...
          {mobileMenuOpen && (
            <div className="md:hidden py-4 border-t border-gray-200">
              <div className="flex flex-col gap-4">
                <button onClick={() => scrollToSection('features')} className="text-gray-700 hover:text-blue-600 transition text-left">
                  Features
                </button>
                <button onClick={() => scrollToSection('pricing')} className="text-gray-700 hover:text-blue-600 transition text-left">
                  Pricing
                </button>
                <button onClick={() => scrollToSection('affiliate')} className="text-blue-600 font-medium hover:underline transition text-left">
                  Become an Affiliate
                </button>
      ...
      <section className="min-h-[calc(100vh-64px)] bg-gradient-to-b from-blue-50 to-white flex items-center justify-center px-4 py-16">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-6">
            ...
            <Button variant="outline" onClick={() => scrollToSection('pricing')} className="border-2 border-gray-300 text-gray-700 rounded-xl px-8 py-6 text-lg hover:border-blue-600">
              See Pricing
            </Button>
          </div>
          <p className="text-sm text-gray-600 text-center mt-6">
            ✨ Trusted by 10,000+ traders • 🤝{' '}
            <button onClick={() => scrollToSection('affiliate')} className="text-blue-600 hover:underline">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <Card className="bg-white rounded-xl shadow-lg hover:shadow-2xl transition-shadow p-8">
              <CardHeader>
                ...
                <CardTitle className="text-2xl font-semibold text-gray-900">Real-time Fractal Analysis</CardTitle>
              </CardHeader>
              <CardContent>
            ...
            <Card className="bg-white rounded-xl shadow-lg hover:shadow-2xl transition-shadow p-8">
              <CardHeader>
                <div className="text-6xl mb-4">🔔</div>
                <CardTitle className="text-2xl font-semibold text-gray-900">Smart Alert System</CardTitle>
              </CardHeader>
              <CardContent>
                <ul className="space-y-2 text-gray-600">
                  <li className="flex items-start">
            ...
            <Card className="bg-white rounded-xl shadow-lg hover:shadow-2xl transition-shadow p-8">
              <CardHeader>
                <div className="text-6xl mb-4">📈</div>
                <CardTitle className="text-2xl font-semibold text-gray-900">Professional Tools</CardTitle>
              </CardHeader>
              <CardContent>
                <ul className="space-y-2 text-gray-600">
                  <li className="flex items-start">
      ...
      <section id="pricing" className="py-20 px-4 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl sm:text-4xl font-bold text-center mb-12 text-gray-900">Simple, Transparent Pricing</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            {/* Free Tier */}
            <Card className="bg-white rounded-xl shadow-lg">
              <CardHeader>
                <div className="mb-4">
                  <span className="bg-green-500 text-white rounded-full px-4 py-1 text-sm font-semibold inline-block">FREE TIER 🆓</span>
                </div>
                <CardTitle className="text-5xl font-bold text-gray-900 mb-4">$0<span className="text-xl text-gray-500">/month</span></CardTitle>
              </CardHeader>
              <CardContent>
              ...
              <CardFooter>
                <Button variant="outline" className="w-full text-lg py-6">Start Free</Button>
              </CardFooter>
            </Card>
            ...
            <Card className="bg-white rounded-xl shadow-lg relative border-2 border-blue-600">
              ...
              <div className="absolute -top-3 right-4">
                <span className="bg-blue-600 text-white rounded-full px-4 py-1 text-xs font-semibold">Most Popular</span>
              </div>
              ...
              <CardHeader>
                <div className="mb-4 mt-2">
                  <span className="bg-blue-600 text-white rounded-full px-4 py-1 text-sm font-semibold inline-block">PRO TIER ⭐</span>
                </div>
                ...
                {!affiliateCode && (
                  <div className="bg-yellow-50 border-l-4 border-yellow-400 p-3 rounded-lg mb-4">
                    ...
                    <button onClick={() => scrollToSection('affiliate')} className="text-yellow-600 text-xs underline hover:text-yellow-700">
                      Apply code →
                    </button>
                  </div>
                )}
                ...
                <div className="mb-2">
                  <p className="text-sm text-gray-500 uppercase font-semibold mb-1">Starting at</p>
                  <CardTitle className="text-5xl font-bold text-gray-900">
                    {proPriceDisplay}<span className="text-xl text-gray-500">/month</span>
                  </CardTitle>
                  {!affiliateCode && (
                    <p className="text-sm text-gray-500 mt-2">($29/month without referral code)</p>
                  )}
                </div>
              </CardHeader>
              <CardContent>
              ...
              <CardFooter className="flex flex-col gap-2">
                ...
                <button onClick={() => scrollToSection('affiliate')} className="text-blue-600 text-sm hover:underline">
      ...
      <section id="affiliate" className="bg-gradient-to-r from-blue-50 via-purple-50 to-pink-50 py-16 px-4">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            <div>
              ...
              <h3 className="font-semibold text-lg mb-1 text-gray-900">Generous Commissions</h3>
              <p className="text-sm text-gray-600">Earn 20% of every subscription ($5.80/month per referral)</p>
            </div>
            <div>
              <div className="text-4xl mb-2">🔗</div>
              <h3 className="font-semibold text-lg mb-1 text-gray-900">Easy to Share</h3>
              <p className="text-sm text-gray-600">Get your unique referral code and share it anywhere</p>
            </div>
            <div>
              <div className="text-4xl mb-2">📊</div>
              <h3 className="font-semibold text-lg mb-1 text-gray-900">Track Performance</h3>
              <p className="text-sm text-gray-600">Real-time dashboard to monitor your earnings</p>
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-8 sm:gap-12 mb-8">
            ...
            <div>
              <div className="text-3xl font-bold text-purple-600">No Approval</div>
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4 mb-6">
            ...
            <Button variant="outline" className="border-2 border-blue-600 text-blue-600 px-8 py-6 text-lg rounded-xl hover:bg-blue-50">
              Learn More →
            </Button>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400 text-sm">
                <li><button onClick={() => scrollToSection('affiliate')} className="hover:text-white transition">Affiliate Program</button></li>
                <li><button onClick={() => scrollToSection('affiliate')} className="hover:text-white transition">Become a Partner</button></li>
