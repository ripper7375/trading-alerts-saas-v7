      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mx-auto mb-16 grid max-w-5xl gap-8 md:grid-cols-2">
          ...
          <Card className="flex flex-col">
            <CardHeader>
              <Badge className="w-fit text-white" style={{ backgroundColor: '#22c55e' }}>FREE TIER 🆓</Badge>
            ...
            <CardFooter className="flex flex-col gap-2">
              <Button className="w-full py-6 text-lg text-white" style={{ backgroundColor: '#16a34a' }}>
                Start Free
              </Button>
          ...
          {/* PRO TIER */}
          <Card className="relative flex flex-col border-4" style={{ borderColor: '#2563eb' }}>
            {/* Most Popular Ribbon */}
            <div className="absolute top-0 right-0 text-white px-4 py-1 rounded-bl-lg text-sm font-medium" style={{ backgroundColor: '#2563eb' }}>
              ⭐ MOST POPULAR
            </div>

            <CardHeader className="pt-12">
              <Badge className="w-fit text-white" style={{ backgroundColor: '#2563eb' }}>PRO TIER ⭐</Badge>

              {/* Affiliate Discount Banner - conditional */}
              {affiliateCode && (
                <div className="border-l-4 p-3 mt-4 rounded-lg" style={{ 
                  ...
                  <div className="flex items-start gap-2">
                    ...
                    <div className="flex-1">
                      <div className="font-semibold" style={{ color: '#854d0e' }}>Affiliate Discount Active!</div>
                      <div className="text-sm" style={{ color: '#a16207' }}>
                        {discountPercent}% off applied with code: <span className="font-mono font-bold">{affiliateCode}</span>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <CardTitle className="flex flex-wrap items-baseline gap-2 mt-4">
                {affiliateCode && (
                  <span className="text-3xl text-muted-foreground line-through">${regularPrice}</span>
                )}
                <span className={`text-6xl font-bold`} style={affiliateCode ? { color: '#16a34a' } : {}}>
            ...
            <CardContent className="flex-1">
              <ul className="space-y-3">
                ...
                <li className="flex items-center gap-2">
                  <Check className="h-5 w-5 flex-shrink-0" style={{ color: '#2563eb' }} />
            ...
            <CardFooter className="flex flex-col gap-2">
              <Button className="w-full py-6 text-lg animate-pulse text-white" style={{ backgroundColor: '#2563eb' }}>
                Start 7-Day Trial {affiliateCode && `(${discountPercent}% Off)`}
              </Button>
              <p className={`text-center text-sm ${affiliateCode ? "" : "text-muted-foreground"}`} style={affiliateCode ? { color: '#16a34a' } : {}}>
        ...
        <div className="border-2 rounded-xl p-6 mb-12 max-w-4xl mx-auto" style={{ 
          ...
          <div className="flex flex-col md:flex-row items-center gap-4">
            ...
            <div className="flex-1 text-center md:text-left">
              ...
              <a href="/affiliate" className="font-medium" style={{ color: '#2563eb' }}>
          ...
          <div className="space-y-4">
            ...
            <details className="group rounded-lg bg-muted/30 overflow-hidden">
              ...
              <p className="px-4 pb-4 text-muted-foreground">
                ...
                (price drops from ${regularPrice} to ${discountedPrice.toFixed(2)}). This is a one-time discount per code. To get the discount again next month,
        ...
        {/* Final CTA */}
        <div className="rounded-xl p-12 text-center" style={{ backgroundColor: 'oklch(0.96 0.02 240)' }}>
          <h2 className="text-3xl font-bold mb-4">Ready to get started?</h2>
          <p className="text-xl text-muted-foreground mb-8">Join thousands of traders using our platform</p>
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <Button className="px-8 py-6 text-lg text-white" style={{ backgroundColor: '#16a34a' }}>
              Start Free
            </Button>
            <Button variant="outline" className="border-2 px-8 py-6 text-lg" style={{ borderColor: '#2563eb' }}>
              Contact Sales
            </Button>
          </div>
        </div>
