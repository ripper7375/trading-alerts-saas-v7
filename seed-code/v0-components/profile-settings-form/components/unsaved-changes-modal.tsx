...
export function UnsavedChangesModal({ isOpen, onStayAndSave, onLeave, onCancel }: UnsavedChangesModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
      <div className="max-w-md w-full bg-white rounded-2xl shadow-2xl p-6">
        ...
        <p className="text-gray-600 mb-6">Are you sure you want to leave? Your changes will be lost.</p>
        <div className="flex flex-col gap-3">
          <Button onClick={onStayAndSave} className="w-full bg-blue-600 hover:bg-blue-700">
            Stay & Save
          </Button>
          <Button
            onClick={onLeave}
