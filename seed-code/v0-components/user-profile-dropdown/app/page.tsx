    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <nav className="border-b-2 border-gray-200 bg-white">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-4">
          ...
          <UserProfileDropdown user={freeUser} usage={freeUsage} onSignOut={handleSignOut} onUpgrade={handleUpgrade} />
        </div>
      </nav>
      ...
      <main className="mx-auto max-w-7xl px-4 py-12">
        <div className="mb-8 rounded-xl border-2 border-gray-200 bg-white p-8">
          <h2 className="mb-4 text-3xl font-bold text-gray-900">User Profile Dropdown Demo</h2>
          <p className="mb-6 text-gray-600">
            This demo showcases the user profile dropdown component with all features including tier badges, menu items,
            and sign-out flow.
          </p>

          <div className="space-y-4">
            <div className="rounded-lg bg-blue-50 p-4">
              <h3 className="mb-2 font-semibold text-blue-900">Current Demo: FREE Tier User</h3>
        ...
        <div className="rounded-xl border-2 border-gray-200 bg-white p-8">
          <h3 className="mb-4 text-2xl font-bold text-gray-900">PRO Tier Example</h3>
          <p className="mb-4 text-gray-600">Click the profile dropdown below to see the PRO tier version:</p>
